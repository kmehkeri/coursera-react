...
const isValidEmail = (val) => !val || /^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}/i.test(val);
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className="text-danger" model=".firstname" show="touched"
                                        messages={{ required: 'Required', minLength: 'Minimum 2 characters', maxLength: '15 characters or less' }} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className="text-danger" model=".telnum" show="touched"
                                        messages={{ required: 'Required', minLength: 'Minimum 2 characters', maxLength: '15 characters or less', isNumber: 'Must be a number' }} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className="text-danger" model=".email" show="touched"
                                        messages={{ required: 'Required', maxLength: '100 characters or less', isValidEmail: 'Must be a valid email' }} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
